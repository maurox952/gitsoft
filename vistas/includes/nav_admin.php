        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    <a class="nav-link" aria-current="page" href="<?php echo $URL ?>/index.php">Incio</a>
                    <a class="nav-link" href="<?php echo $URL ?>/vistas/quines/quienes_somos.php">Quiénes somos</a>
                    <a class="nav-link" href="#">Nuestros servicios</a>
                    <a class="nav-link" href="#">Clientes</a>
                    <a class="nav-link" href="<?php echo $URL ?>">Contáctanos</a>
                    <a class="nav-link" href="<?php echo $URL ?>/vistas/login/cerrar_sesion.php">Cerrar sesion</a>
                </div>
            </div>
        </div>
    </nav>
