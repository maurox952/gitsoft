...
$sql=$conn->query("INSERT INTO tblempleado (id, nombres, apellidos, celular, fecha_nacimiento, correo, id_cargo, direccion, ciudad, departamento, id_rol, sexo) VALUES ('$identificacion', '$nombres', '$apellidos', '$celular', '$fecha_naci', '$correo', '$cargo', '$direccion', '$ciudad', '$departamento', 2 , '$sexo')");
